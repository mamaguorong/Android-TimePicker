...
import com.bigkoo.pickerview.listener.OnTimeRangeSelectChangeListener;
import com.bigkoo.pickerview.listener.OnTimeRangeSelectListener;
import com.bigkoo.pickerview.listener.OnTimeSelectChangeListener;
import com.bigkoo.pickerview.listener.OnTimeSelectListener;
import com.bigkoo.pickerview.view.TimePickerView;
import com.bigkoo.pickerview.view.TimeRangePickerView;
...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder(Context context, OnTimeRangeSelectListener listener) {
        mPickerOptions = new PickerOptions(PickerOptions.TYPE_PICKER_TIME);
        mPickerOptions.context = context;
        mPickerOptions.timeRangeSelectListener = listener;
    }
    ...
    public TimePickerBuilder setSelectRangDate(Calendar startSelectDate, Calendar endSelectDate) {
    ...
    public TimePickerBuilder setTimeRangeSelectChangeListener(OnTimeRangeSelectChangeListener listener) {
        mPickerOptions.timeRangeSelectChangeListener = listener;
        return this;
    }
    ...
    public TimeRangePickerView buildRange() {
        return new TimeRangePickerView(mPickerOptions);
    }
}
