...
public class PickerOptions {
    ...
    public OnTimeRangeSelectChangeListener timeRangeSelectChangeListener;
    public OnTimeRangeSelectListener timeRangeSelectListener;
    ...
    public Calendar startSelectDate;//选中开始时间
    public Calendar endSelectDate;//选中终止时间
