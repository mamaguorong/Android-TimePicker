...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TimeRangePickerView timeRangePickerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_rangetime=findViewById(R.id.btn_rangetime);
        btn_rangetime.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initTimeRangePicker() {//Dialog 模式下，在底部弹出
